...
%	\doclicenseThis
	...
	\section{Lecture 1. Jan. 7 2019\\Games and Dominant Strategies}
		...
		\begin{definition}
			Action $a_i \in A_i$ is \textbf{strictly(weakly) dominant} if it strictly(weakly) dominates \red{all} other actions.
		\end{definition}
		
		\begin{definition}
			Action $a_i \in A_i$ is \textbf{strictly(weakly) dominated} if \red{there exists} another strategy strictly(weakly) dominates $a_i$.
		\end{definition}
...
%					\end{proposition}
	...
	\section{Lecture 9 Mar. 18 2019}
		...
		\subsection{Formal Definitions}
			\begin{definition}[Bayesian Game] A \textbf{Bayesian Game} consists the following components
				\begin{enumerate}[(i)]
