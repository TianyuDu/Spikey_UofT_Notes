...
%		\end{figure*}
	...
	\section{Lecture 7 Oct. 25 2018}
		...
		\subsection{Experiment: an unexpected fall in the discounted rate $\rho$.}
			\par Suppose the change in unexpected \footnote{If a change is expected, households may alter their behaviour before the change occurs.} \\
	...
	\section{Lecture 8 Nov. 1 2018}
		...
		\subsection{Government Spending: with bonds (voluntary taxation)}
			...
			\begin{proposition}
				...
				\begin{definition}[Ricardian Equivalence]
