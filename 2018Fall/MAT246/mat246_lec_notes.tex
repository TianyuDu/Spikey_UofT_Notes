...
\begin{document}
	...
	\section{Lecture 24. Nov 12. 2018}
		...
		\begin{remark}[How to Prove Same Cardinality with Natural Numbers]
	...
	\section{Lecture 33. Dec. 3 2018}
		...
		\begin{theorem}
			If a cubic polynomial with \ul{rational coefficients} has constructible root(s), then is also have rational root(s).
		\end{theorem}
