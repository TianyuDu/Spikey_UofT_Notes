	...
	\section{Differentiation and related topics}
		...
		\subsection{Critical Points}
			...
			\begin{corollary}
				...
				\end{enumerate}
				\emph{If none of the above holds (i.e. semi-definiteness), then we cannot determine the character of the critical point without further thought.}
			\end{corollary}
	...
	\section{Vector Calculus}
		...
		\subsection{Divergence Theorem}
			...
			\begin{theorem}[Divergence Theorem]
				Let $R \subseteq \R^3$ be a \ul{regular region} with \ul{piece-wise smooth boundary} $\partial S$. And $\ve{n}$ is the \ul{outer normal vector} on $\partial S$, then,
				\begin{equation}
