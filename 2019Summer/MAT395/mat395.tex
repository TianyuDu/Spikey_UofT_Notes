...
\begin{document}
	...
	\section{Chapter 16. Equilibrium and Its Basic Welfare Properties}
		...
		\begin{theorem}[The First Fundamental Theorem of Welfare Economics]
			In any private ownership economy where the set of consumers is finite, and all consumers preferences are locally nonsatiated, then all Walrasian equilibrium allocation is Pareto efficient.
		\end{theorem}
