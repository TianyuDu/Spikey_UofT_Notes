...
%		\end{align}
	...
	\begin{example}
		Let $f(x) = x^2$, then $\frac{f'(x)}{f''(x)} = \frac{2x}{2}$. For any starting point $x_0$, $x_1 = x_0 - \frac{2x_0}{2} = 0$. That is, the algorithm converges to the global minimum in one iteration.
	\end{example}
