...
%		\end{align}
	...
	\begin{example}[Special Case: Method of Conjugate Direction on Quadratic Functions]
		Let $Q \in \S_{++}^n$ and minimizing the quadratic function
		\begin{align}
	...
	\begin{algorithm}[Method of Conjugate Directions]
		Let $Q \in \S_{++}^n$ and $\{d_j\}_{j=0}^{n-1}$ be a set of non-zero $Q$-orthogonal vectors, note that they form a basis of $\R^n$. \\
	...
	\begin{theorem}
		Given the method of conjugate, the sequence of points generated eventually reaches the global minimum. That is, $x_k = x^*$.
	\end{theorem}
